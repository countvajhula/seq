...
(module+ test
  ...
  (check-equal? (->list (every 3 (list 1 2 3 4))) '(1 4))
  ...
  (check-equal? (->list (map ->list (split-by 2 (list 1 2 3 4 5 6)))) '((1 2) (3 4) (5 6)))
  (check-equal? (->list (map ->list (split-by 2 (list 1 2 3 4 5)))) '((1 2) (3 4)))
  (check-equal? (->list (map ->list (split-by 3 (list 1 2 3 4 5)))) '((1 2 3)))
  (check-equal? (->list (map ->list (split-by 3 (list 1 2 3)))) '((1 2 3)))
  (check-equal? (->list (map ->list (split-by 3 (list 1 2)))) '())
  (check-equal? (->list (map ->list (split-by 3 (list 1)))) '())
  (check-equal? (->list (map ->list (split-by 3 (list)))) '())
