...
(module+ test
  ...
  (check-equal? (->list (zip list (naturals 1) (list 'a 'b 'c))) '((1 a) (2 b) (3 c)))
  (let ([seqs (list
               (list (list 1 2 3) (list 1 2 3))
               (list (list 1 2 3) (list 1 2 3) (list 1 2 3))
               (list (list 1 2 3)))])
    (for-each (λ (seq)
                (check-equal? (->list (unzip list (apply zip list seq)))
                              seq))
              seqs))
  (check-equal? (->list (unzip string (zip (.. string->immutable-string string) "hello" "there")))
                (list "hello" "there"))
  (check-equal? (->list (unzip list (zip list (list 1 2 3) (list 1 2 3 4))))
                (list (list 1 2 3) (list 1 2 3)))
  (check-equal? (->list (unzip list (zip list (list 1 2 3 4) (list 1 2 3))))
                (list (list 1 2 3) (list 1 2 3)))
  (check-equal? (->list (unzip list (zip list (naturals 1) (list 'a 'b 'c))))
