...
(module+ test
  ...
  (check-equal? (->string (trim #\h "hellohhh")) "ello")
  (check-equal? (->list (map ->string (split-when (curry = #\space) "hello there"))) (list "hello" "there"))
  (check-equal? (->list (map ->string (split-when (curry = #\space) " "))) (list ""))
  (check-equal? (->list (map ->string (split-when #:trim? #f (curry = #\space) " "))) (list "" ""))
  (check-equal? (->list (map ->string (split-when (curry = #\space) ""))) (list ""))
