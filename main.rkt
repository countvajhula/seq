...
(module+ test
  ...
  (check-equal? (->list (merge list (list 1 2 3) (list 1 2 3))) '((1 1) (2 2) (3 3)))
  (check-equal? (->list (merge list (list 1 2 3))) '((1) (2) (3)))
  (check-equal? (->list (merge list (list) (list))) '())
  (check-equal? (->list (merge string "hello" "there")) (list "ht" "eh" "le" "lr" "oe"))
