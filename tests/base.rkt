  ...
  (define tests
    (test-suite
     ...
     (test-case
       ...
       (check-equal? (->list (map ->string (cut-when (curry = #\space) (trim-if char-whitespace? " ")))) (list ""))
     ...
     (test-case
       ...
       (check-equal? (->list (map ->list (cut 5 (trim 5 (list 5))))) '(()))
       (check-equal? (->list (map ->list (cut 5 (list 5)))) '(() ()))
       (check-equal? (->list (map ->list (cut 5 (list 1 2 3)))) '((1 2 3)))
       (check-equal? (->list (map ->list (cut 5 (trim 5 (list 5 5 5 1 2 5 2 3 5 6 5 7 8 5 5 5))))) '((1 2) (2 3) (6) (7 8)))
       (check-equal? (->list (map ->list (cut 5 (list 5 5 5 1 2 5 2 3 5 6 5 7 8 5 5 5)))) '(() () () (1 2) (2 3) (6) (7 8) () () ()))
       (check-equal? (->list (map ->list (cut 5 (trim 5 (list 5 5 5 1 2 5 5 2 3 5 6 5 7 8 5 5 5))))) '((1 2) () (2 3) (6) (7 8)))
       (check-equal? (->list (map ->list (cut 5 (trim 5 (list 1 2 5 2 3 5 6 5))))) '((1 2) (2 3) (6)))
